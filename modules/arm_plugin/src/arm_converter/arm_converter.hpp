...
inline std::ostream& operator<< (std::ostream& out, const arm_compute::Tensor& t) {
    ...
    size_t showlen = t.info()->dimension(0) > 10 ? 10 : t.info()->dimension(0);
    ...
    switch (t.info()->data_type()) {
        ...
        case arm_compute::DataType::QASYMM8_SIGNED: print_vals(reinterpret_cast<  uint8_t*>(dptr), "QAS8"); break;
